...
{
	Task<bool> ValidateAddress(SpeedyAccount account, string country, string city, string street, CancellationToken ct = default);
	Task<bool> ValidatePhone(SpeedyAccount account, string phone, CancellationToken ct = default);
